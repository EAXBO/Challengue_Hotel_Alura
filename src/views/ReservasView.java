...
//238, 493, 122, 35
	...
	public void calcularValor(JDateChooser dataE, JDateChooser dataS) {
		if(dataE.getDate()!=null && dataS.getDate()!=null) {
			if(dataE.getDate().after(dataS.getDate())) {
				JOptionPane.showMessageDialog(null, "La fecha de entrada no puede ser posterior a la fecha e salida", "Error Fechas", JOptionPane.ERROR_MESSAGE);
				return;
			}
	...
	//esto es para cuando actualicemos las fechas se limpie el valor
